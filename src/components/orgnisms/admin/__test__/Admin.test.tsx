...
import { PostActionTypes, GetUsersStateType} from '../../../../action/actionType'
...
function thunkMiddleware(thunkMiddleware: any): import("redux").StoreEnhancer<{ dispatch: unknown; }, {}> | undefined {
